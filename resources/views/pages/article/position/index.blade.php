...
@section('article-position-job', 'active')
@section('content')
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    @forelse ($jobs as $job)
                                        <tr>
                                            ...
                                            <td>{{ $job->username ?? '' }}</td>
                                            <td>{{ $job->total_like}} </td>
                                            <td>{{ $job->total_dislike}} </td>
                                            <td>{{ $job->created_at }}</td>
                                            <td>
                                                <div class="text-center d-flex">
                                                    <a href="{{ route('job.getJobIDByPosition', $job->id) }}" class="btn btn-primary btn-sm">Detail</a>
                                                </div>
                                            </td>
                                        </tr>
                                    @empty
